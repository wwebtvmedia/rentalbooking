...
export default function PrivacyPage() {
  return (
    <Layout title="Privacy Policy | dreamflat">
      <section className="py-40">
        <div className="container max-w-4xl">
          ...
          <div className="prose prose-luxury">
            ...
            <p className="mb-6">At dreamflat, we respect your privacy. This policy outlines how we collect, use, and protect your personal information.</p>
